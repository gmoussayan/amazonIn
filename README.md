...
+ **iFailTestCase**, which will try to sign in with an invalid username and password, and intentionally fail the test to generate the HTML report.
...
notes:
- i will be digging later on into stabilizing some areas of the test, and add a few more test cases.
- There are few other files not used in the above run but can meanwhile be used to play around tests and TestNG Annotations.
